...
export default function SaraswatiVandanaDataDeletionPage({ navigation, footer, page }) {
  return (
    <div className={styles.pageShell}>
      <Navbar navigation={navigation} />
      <main className={styles.page} aria-label="Delete Your Data Saraswati Vandana">
...
export async function getStaticProps() {
  ...
  const page = getPageContent("saraswati-vandana-data-deletion");
  return {
    props: {
      navigation,
      footer,
