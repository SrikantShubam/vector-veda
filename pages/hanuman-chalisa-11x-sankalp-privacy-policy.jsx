...
export default function HanumanChalisaPrivacyPolicyPage({ navigation, footer, page }) {
  return (
    <div className={styles.pageShell}>
      <Navbar navigation={navigation} />
      <main className={styles.page} aria-label="Hanuman Chalisa 11x Sankalp Privacy Policy">
...
export async function getStaticProps() {
  ...
  const page = getPageContent("hanuman-chalisa-11x-sankalp-privacy-policy");
  return {
    props: {
      navigation,
      footer,
