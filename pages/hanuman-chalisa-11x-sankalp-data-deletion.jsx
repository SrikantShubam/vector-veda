...
export default function HanumanChalisaDataDeletionPage({ navigation, footer, page }) {
  return (
    <div className={styles.pageShell}>
      <Navbar navigation={navigation} />
      <main className={styles.page} aria-label="Delete Your Data Hanuman Chalisa 11x Sankalp">
...
export async function getStaticProps() {
  ...
  const page = getPageContent("hanuman-chalisa-11x-sankalp-data-deletion");
  return {
    props: {
      navigation,
      footer,
