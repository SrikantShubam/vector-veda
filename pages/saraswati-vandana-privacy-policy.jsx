...
export default function SaraswatiVandanaPrivacyPolicy({
  navigation,
  footer,
  page
}) {
  return (
    <div className={styles.pageShell}>
      ...
      <main className={styles.page} aria-label="Saraswati Vandana Privacy Policy">
...
export async function getStaticProps() {
  ...
  const page = getPageContent("saraswati-vandana-privacy-policy");
  return {
    props: {
      navigation,
      footer,
